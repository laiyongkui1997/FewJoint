...
DEFAULT_RAW_DIR = '/SMP_RAW_DATA'
DEFAULT_DATA_DIR = '/SMP_DATA'
BERT_BASE_UNCASED = '/bert-base-uncased/uncased_L-12_H-768_A-12/'
BERT_BASE_UNCASED_VOCAB = '/bert-base-uncased/uncased_L-12_H-768_A-12/vocab.txt'
...
def basic_args(parser):
    ...
    group = parser.add_argument_group('Device')  # default to use all available GPUs
    group.add_argument("--record_proto", default=False, action='store_true',
...
def train_args(parser):
    ...
    group.add_argument("--ft_num_train_epochs", default=10, type=float, help="The epoch num in Fine-tune")
...
def model_args(parser):
    ...
    group.add_argument("--proto_scale_r", default=1, type=float, help="Scale given prototype reps to x times")
