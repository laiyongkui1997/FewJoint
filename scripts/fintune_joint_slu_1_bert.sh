...
pretrained_vocab_path=/chinese_L-12_H-768_A-12/vocab.txt

# electra small path
#pretrained_model_path=/electra-small-discriminator
#pretrained_vocab_path=/electra-small-discriminator

# data path
base_data_dir=/data/new_smp_true/  # smp data
#base_data_dir=/data/new_few_shot_data/
                                    ...
                                    do
                                        ...
                                        do
                                            ...
                                            do
                                                ...
                                                do
                                                    for ft_num_train_epochs in ${ft_num_train_epochs_lst[@]}
                                                    do
                                                        for ft_layer_num in ${ft_layer_num_lst[@]}
                                                        do
                                                            for ft_td_rate in ${ft_td_rate_lst[@]}
                                                            do
                                                                # model names
                                                                model_name=few_joint.sft_ep_${ft_num_train_epochs}.ly_num_${ft_layer_num}.${ft_dataset}_${ft_td_rate}.${task}.bert.joint_bert_model.ga_${grad_acc}.bs_${train_batch_size}.sim_${similarity}.ems_${emission}_${emission_normalizer}.dec_${decoder}${label_wp}${finetune}${use_schema}${do_debug}${no_cuda}

                                                                data_dir=${base_data_dir}smp.${cross_data_id}.spt_s_3.q_s_4.ep_50${use_schema}--fix_dev_spt/
                                                                ...
                                                                CUDA_VISIBLE_DEVICES=${gpu_list} python main.py ${do_debug} \
                                                                    ...
                                                                    --ft_td_rate ${ft_td_rate} \
                                                                    --ft_num_train_epochs ${ft_num_train_epochs} \
                                                                    --ft_layer_num ${ft_layer_num} \
                                                                    ${label_wp} \
                                                                    ...
                                                                    ${do_div_emission} \
                                                                    --decoder ${decoder} \
                                                                    --transition learn > ./result/FewJointRelease/${model_name}.DATA.${file_mark}.log
                                                                echo [CLI]
                                                                echo Model: ${model_name}
                                                                echo Task:  ${file_mark}
                                                                echo [CLI]
