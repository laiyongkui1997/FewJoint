                                                ...
                                                do
                                                    ...
                                                    do
                                                        ...
                                                        do
                                                            ...
                                                            do
                                                                # model names
                                                                model_name=few_joint.loss_scale_type_${loss_scale_type}.${slu_model_type}.split_metric_${split_metric}_dim_${metric_dim}_act_${metric_activation}.${task}.bert.joint_bert_model.ga_${grad_acc}.bs_${train_batch_size}.sim_${similarity}.ems_${emission}_${emission_normalizer}.dec_${decoder}${use_schema}${do_debug}
