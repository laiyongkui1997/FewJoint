                                    ...
                                    do
                                        ...
                                        do
                                            ...
                                            do
                                                ...
                                                do
                                                    # model names
                                                    model_name=few_joint.${task}.bert.joint_bert_model.ga_${grad_acc}.bs_${train_batch_size}.sim_${similarity}.ems_${emission}_${emission_normalizer}.dec_${decoder}${use_schema}${do_debug}
